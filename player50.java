...
public void run()
{
    ...
    Arrays.fill(parentsIndices, -1); // make the while loop below finite!
    ...
    while(evals<evaluations_limit_){
        int i = 0;
        while (i < selectionSize) { // make sure to make this while loop finite
        ...
        int j = 0;
        while (j < selectionSize) { // make sure to make this while loop finite
